...
namespace DryPants.Resources {
    ...
    internal class Errors {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The start date of a period can not be past the end date..
        /// </summary>
        internal static string Period_StartDatePastEndDate {
            get {
                return ResourceManager.GetString("Period_StartDatePastEndDate", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Unable to create an instance of the type {Name}. Implement TypeConvertAppSetting to convert to it manually..
        /// </summary>
